...
namespace EmployeeManagement.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "EmployeeManagementLookup", Version = "v1" });
            });
            #region Allow-Orgin
            services.AddCors(c =>
            {
            ...
            services.AddScoped<EmployeeManagementConfig>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint($"{path}/swagger/v1/swagger.json", "EmployeeManagementLookup V1"); 
